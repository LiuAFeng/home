...
(function (factory) {
    ...
    $.support.cors = true;
    $.fn.accound_citys = function(parameter,getApi) {
        ...
        var defaults = {
            ...
            provinceField:'accound_province', //省份字段名
            cityField:'accound_city',         //城市字段名
            areaField:'accound_area',         //地区字段名
    ...
    $.fn.live_citys = function(parameter,getApi) {
        if(typeof parameter == 'function'){ //重载
            getApi = parameter;
            parameter = {};
        }else{
        ...
        var defaults = {
            dataUrl:'http://passer-by.com/data_location/list.json',     //数据库地址
            dataType:'json',          //数据库类型:'json'或'jsonp'
            provinceField:'live_province', //省份字段名
            cityField:'live_city',         //城市字段名
            areaField:'live_area',         //地区字段名
            valueType:'code',         //下拉框值的类型,code行政区划代码,name地名
            code:0,                   //地区编码
            province:0,               //省份,可以为地区编码或者名称
            city:0,                   //城市,可以为地区编码或者名称
    ...
    $.fn.unit_citys = function(parameter,getApi) {
        if(typeof parameter == 'function'){ //重载
            getApi = parameter;
            parameter = {};
        }else{
        ...
        var defaults = {
            dataUrl:'http://passer-by.com/data_location/list.json',     //数据库地址
            dataType:'json',          //数据库类型:'json'或'jsonp'
            provinceField:'unit_province', //省份字段名
            cityField:'unit_city',         //城市字段名
            areaField:'unit_area',         //地区字段名
            valueType:'code',         //下拉框值的类型,code行政区划代码,name地名
            code:0,                   //地区编码
            province:0,               //省份,可以为地区编码或者名称
            city:0,                   //城市,可以为地区编码或者名称
